<template>
    <div class="list-box">
        <div class="list-add">
            定期检查
            <el-button type="success" @click="addEvent">添加定期检查信息</el-button>
        </div>
        <el-table
            :data="list"
            border
        ...
        >
            ...
            <el-table-column prop="hao" label="路面平整度监测记录单号" width="200" align="center"></el-table-column>
            ...
            <el-table-column prop="iri" label="IRI测量值" align="center"></el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="editVisible" width="35%" >
            <div class="values">
                <!-- <div>
                    路面平整度监测记录单号<el-input v-model="values.hao" placeholder="路面平整度监测记录单号"></el-input>
                </div> -->
                <!-- <div>
                ...
                <div>
                    IRI<el-input v-model="values.iri" placeholder="IRI"></el-input>
                </div>
                <div>
...
export default {
    ...
    methods:{
        ...
        saveEdit(){
            for(let i in this.values ) if(!this.values[i] &&i!='bz')return this.$message.error("请填写定期检查内容")
           if(this.is)
           this.axios({
                path:"/user/addDq",
                data:{
